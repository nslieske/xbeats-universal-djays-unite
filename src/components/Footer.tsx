...
const Footer = () => {
  return (
    <footer className="bg-xbeats-darker py-12 mt-12">
        ...
        <div className="flex flex-col md:flex-row justify-between">
          ...
          <div className="mb-8 md:mb-0 max-w-sm">
            ...
            <p className="text-white/70 mb-6">
              The universal music platform that brings all your favorite services together.
            </p>
            <div className="text-sm text-white/50">
              © 2025 xBeats. All rights reserved.
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-white/70 hover:text-white">Integrations</a></li>
                <li><a href="#" className="text-white/70 hover:text-white">Pricing</a></li>
                <li><a href="#" className="text-white/70 hover:text-white">Updates</a></li>
              </ul>
            </div>
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-white/70 hover:text-white">API Docs</a></li>
                <li><a href="#" className="text-white/70 hover:text-white">Community</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li><a href="#" className="text-white/70 hover:text-white">Licenses</a></li>
              </ul>
            </div>
          </div>
        </div>
